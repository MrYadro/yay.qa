...
# Soft
- OS `Proxmox`
- `qBittorrent` + `qui` - скачивать образы Linux чистить мертвые закачки и тп
...
- `dispatcharr` - менеджер телеканалов для jellyfin
- `navidrome` - библиотека музыки
- `Paperless-ngx` - хранилка документов с распознаванием текста и конвертации его в pdf
...
- `flaresolverr` - убираем проверку от cloudflare
- `homebox` - каталог вещей в доме и на складе
...
- `lidarr` - управление библиотекой музыки
